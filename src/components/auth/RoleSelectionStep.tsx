    ...
    return (<div className="space-y-6">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-8">
            <button
                ...
                className={`group relative overflow-hidden p-6 rounded-2xl border-2 transition-all duration-300 text-left ${role === 'patient'
            ...
            >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors ${role === 'patient' ? 'bg-indigo-600 text-white' : 'bg-indigo-100 text-indigo-600 group-hover:bg-indigo-200'
                    }`}>
            ...
            <button
                ...
                className={`group relative overflow-hidden p-6 rounded-2xl border-2 transition-all duration-300 text-left ${role === 'doctor'
                    ? 'border-teal-500 bg-teal-50/50 shadow-md shadow-teal-100'
                    : 'border-slate-200 hover:border-teal-200 hover:bg-slate-50 bg-white'
                    }`}
            >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 transition-colors ${role === 'doctor' ? 'bg-teal-500 text-white' : 'bg-teal-100 text-teal-600 group-hover:bg-teal-200'
                    }`}>
